<?php
    ...
    if(!$db){
        ...
        $id=$_GET['ID'];
        $qry="SELECT * FROM klienti where ID=$id";
        $run=$db->query($qry);
        if($run->num_rows>0){
            while($row=$run->fetch_assoc()){
                $emri=$row['Emri'];
                $nrtel=$row['Nr_tel'];
                $destinacioni=$row['Destinacioni'];
                $persona=$row['Persona'];
                $nisja=$row['Nisja'];
                $arritja=$row['Arritja'];
            }
...
<section class="booking">
   ...
   <form method="post" class="book-form">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>name :</span>
            <input type="text" value="<?php echo $emri ;?>" name="emri" id="name">
         </div>
         <div class="inputBox">
            <span>phone :</span>
            <input type="text" value="<?php echo $nrtel ;?>" name="nrtel" id="nrtel">
         </div>
         <div class="inputBox">
            <span>where to :</span>
            <input type="text" value="<?php echo $destinacioni ;?>" name="destinacioni" id="location">
         </div>
         <div class="inputBox">
            <span>how many :</span>
            <input type="text" value="<?php echo $persona ;?>" name="persona" id="persona">
         </div>
         <div class="inputBox">
            <span>Nisja :</span>
            <input type="date" name="nisja" value="<?php echo $nisja;?>">
         </div>
         <div class="inputBox">
            <span>Arritja :</span>
            <input type="date" name="arritja" value="<?php echo $arritja ;?>">
         </div>
      </div>

      <input onclick="validoBook()" type="submit" value="update" class="btn" name="update" > 
...
<?php
    ...
    $qry="UPDATE klienti set Emri='$emri',Nr_tel='$nrtel',
    Destinacioni='$destinacioni',Persona='$persona',
    Nisja='$nisja',Arritja='$arritja'
    where ID=$id";
